...
<span style="color: red">**EXPERT**</span> This [repository](https://github.com/vianneydenis/OCEAN5098B.git) available on GitHub is the working directory of the OCEAN5098B.Rproj file and it contains all of the .Rmd, .html and data files used to review this course. While you can can individually download and render the .Rmd files. It is better to **fork** this repository to your GitHub account, then clone a copy of this forked repository (from your own Github account to your computer) and use the function `render_site` of the `rmarkdown` package. It requires advanced understanding on several aspects of R, RStudio, and R Markdown but you may be adventurous and give it a try. This will take some time.  
